...
<div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    <div class="flex-1 flex flex-col min-w-0 h-full overflow-x-hidden">
        
        <header class="bg-white border-b border-gray-200 shadow-sm z-20 flex-shrink-0 overflow-x-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 overflow-x-hidden p-4 md:p-8 scroll-smooth">
