...
$pageTitle = '403 Forbidden | Trevio';
...
<div class="flex min-h-[70vh] flex-col items-center justify-center px-6 py-12 text-center">
    ...
    <div class="flex flex-col gap-4 sm:flex-row">
        ...
        <a href="<?= htmlspecialchars($loginUrl ?? '#') ?>" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2">
